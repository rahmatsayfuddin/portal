            ...
            <div class="container">
              <div class="col-md-3">&nbsp;</div>            
                  ...
                  <div class="col-md-6">
                    ...
                    <?php echo form_open('Register/save_password'); ?>
                    <div class="col-md-8" style="background-color: #fefefe; height: 363px;opacity: 0.9">
                      <div class="col-md-12"><h3><b>Input Password</b></h3></div>
                      
                      <div class="form-group">
                          <input type="email" class="form-control" name="email" placeholder="E-mail" id="email" value="<?php echo $list_user; ?>" readonly="">
                      </div>
                      ...
                      <div class="form-group">
                          <input type="password" class="form-control" name="re_new" id="re_new" placeholder="Confirm Password" required="">
                      </div>
