                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <h3><span class="icon icon-filter" style="color: #ff0027;"></span> Data Produk</h3>
                                    </div>
                                                ...
                                                <div class="col-md-10 col-xs-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                            <button class="btn btn-primary" onclick="search('Product');return false">Search</button>
                                                        </div>
                                                        <div class="input-group-btn">
                                                            <button class="btn btn-default" onclick="refresh('Product');return false">Refresh</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <div id="content-product" class="table-responsive" style="min-height: 200px;"></div>
                                </div>
                            </div>
                            <!-- END PRIMARY PANEL -->
                        </div>
